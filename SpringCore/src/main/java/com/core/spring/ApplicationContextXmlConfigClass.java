...
/**
 * Berikut adalah contoh untuk memanggil DI yang telah dikonfigurasi di xml (xml
 * based configuration) context.getBean("chapter1") => nama dari beans id di xml
 * config
 */

public class ApplicationContextXmlConfigClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(myFirstSpringBook.getTitle());
